...
import com.houduan.drone.Exception.BusinessException;
...
public class AssertUtils {
    ...
    /**
     * 权限确认 —— 校验当前 ThreadLocal 中的用户角色是否匹配期望角色
     *
     * @param expectedRole 期望的角色（如 RoleEnum.ADMIN.getRole()）
     */
    public static void validAuth(Integer expectedRole) {
        Integer currentRole = LocalThreadHolder.getRoleId();
        AssertUtils.isTrue(
                Objects.equals(expectedRole, currentRole),
                "无操作权限"
        );
    }
